                ...
                <div class="col-auto bg-dark p-5 w-50">
                    <%
                        try {
                                ...
                                PreparedStatement pst = conexion.prepareStatement("select * from turista where id=?");
                                pst.setInt(1, codigo);
                    ...
                    <form action="./update.jsp" method="GET">
                        ...
                        <div class="input-group p-2">
                            <input type="text" class="form-control" name="dia" value="<% out .print(Tabla.getString(4)); %>">
                        </div>
                        <div class="input-group p-2">
                            <input type="text" class="form-control" name="cel" value="<% out .print(Tabla.getString(5)); %>">
                        </div>
                        <div class="input-group p-2">
                            <input type="email" class="form-control" name="email" value="<% out .print(Tabla.getString(6)); %>">
                        </div>
                        <div class="input-group p-2">
                            <input type="text" class="form-control" name="nacion" value="<% out .print(Tabla.getString(7)); %>">
                        </div>
