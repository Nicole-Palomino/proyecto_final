    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="container" style="margin-top: 90px;">
                                <h1 class="text-center">PANEL DE LOS PAQUETES TURÍSTICOS</h1>
                            </div>
                            <div class="container mt-5">
                                <a href="./create.jsp" class="btn btn-success">Agregar un paquete turístico</a>
                            </div>
        ...
        <%
            try { 
                    ...
                    PreparedStatement  pst = conexion.prepareStatement("Select * from paquete");
                    ResultSet Tabla =pst.executeQuery();
                    out.print("<div class='container mt-5 mb-5'>");
                    out.print("<table  class='table table-hover' >");
                    out.print("<tr class='table-dark text-center'>");
                    out.print("<th>ID  <th>RECORRIDO <th>HORA DE SALIDA <th>HORA DE LLEGADA <th>DIA <th>PRECIO <th colspan=2>ACCIONES" );
                    while (Tabla.next()) {                          
                            out.print("<tr>");
                            out.print("<td>"+Tabla.getObject("id"));
                            out.print("<td>"+Tabla.getObject("recorrido"));
                            out.print("<td>"+Tabla.getObject("hsalida"));
                            out.print("<td>"+Tabla.getObject("hllegada"));
                            out.print("<td>"+Tabla.getObject("dia"));
