    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="container" style="margin-top: 90px;">
                                <h1 class="text-center">PANEL DE TRABAJADOR</h1>
                            </div>
                            <div class="container mt-5">
                                <a href="./create.jsp" class="btn btn-success">Agregar un trabajador</a>
                            </div>
        ...
        <%
            try { 
                    ...
                    PreparedStatement  pst = conexion.prepareStatement("Select * from trabajador");
                    ResultSet Tabla =pst.executeQuery();
                    out.print("<div class='container mt-5 mb-5'>");
                    out.print("<table  class='table table-hover' >");
                    out.print("<tr class='table-dark'>");
                    out.print("<th>ID  <th>NOMBRE  <th>APELLIDO <th>DNI <th>USUARIO <th>CONTRASEÑA <th colspan=2>ACCIONES" );
                    while (Tabla.next()) {                            
                            out.print("<tr>");
                            ...
                            out.print("<td>"+Tabla.getObject("usuario"));
                            out.print("<td>"+Tabla.getObject("contrasena"));
