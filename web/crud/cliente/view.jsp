    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="container" style="margin-top: 90px;">
                                <h1 class="text-center">PANEL DE CLIENTE</h1>
                            </div>
                            <div class="container mt-5">
                                <a href="./create.jsp" class="btn btn-success">Agregar un cliente</a>
                            </div>
        ...
        <%
            try { 
                    ...
                    out.print("<th>ID  <th>NOMBRE  <th>CONTRASEÑA <th colspan=2>ACCIONES" );
                    while (Tabla.next()) {                          
                            out.print("<tr>");
